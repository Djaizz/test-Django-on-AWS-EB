"""
Django settings generated by 'django-admin startproject' using Django 3.0.5
...
ROOT_URLCONF = 'test_django_project._django_project_root.urls'
...
WSGI_APPLICATION = 'test_django_project._django_project_root.wsgi.application'
